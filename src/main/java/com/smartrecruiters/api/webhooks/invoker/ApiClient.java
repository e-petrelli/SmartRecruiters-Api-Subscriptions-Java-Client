...
package com.smartrecruiters.api.webhooks.invoker;
...
import com.smartrecruiters.api.webhooks.invoker.auth.Authentication;
import com.smartrecruiters.api.webhooks.invoker.auth.HttpBasicAuth;
import com.smartrecruiters.api.webhooks.invoker.auth.HttpBearerAuth;
import com.smartrecruiters.api.webhooks.invoker.auth.ApiKeyAuth;
import com.smartrecruiters.api.webhooks.invoker.auth.OAuth;
import com.smartrecruiters.api.webhooks.invoker.auth.RetryingOAuth;
import com.smartrecruiters.api.webhooks.invoker.auth.OAuthFlow;

public class ApiClient {

    private String basePath = "https://api.smartrecruiters.com/webhooks-api/v201907";
    ...
    public ApiClient(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        RetryingOAuth retryingOAuth = new RetryingOAuth("https://www.smartrecruiters.com/identity/oauth/token", clientId, OAuthFlow.accessCode, clientSecret, parameters);
        authentications.put(
                "oauth",
                retryingOAuth
        );
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.smartrecruiters.com/webhooks-api/v201907
