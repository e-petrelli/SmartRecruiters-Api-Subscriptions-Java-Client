...
public class JobWebhookPayload {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private String id;


  public JobWebhookPayload id(String id) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    JobWebhookPayload jobWebhookPayload = (JobWebhookPayload) o;
    return Objects.equals(this.id, jobWebhookPayload.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobWebhookPayload {\n");
